...
namespace frm_select
{
    public class CFPTree
    {
        ...
        public CFPTree(List<Item> frequentItems, List<ItemSet> trxList, int minSupCount)
            : this()
        {
            _minimumSupportCount = minSupCount;

            CalculateFrequentItems(frequentItems);
        ...
        public CFPTree Project(Item anItem)
        {
            var tree = new CFPTree { _minimumSupportCount = _minimumSupportCount };
